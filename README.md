...
| File | What it does |
|------|-------------|
| `package.json` | Lists all the Node.js packages this project depends on and the commands to start/build it. |
| `public/index.html` | The homepage — the first page visitors see. |
| `src/App.css` | A stylesheet that controls the visual appearance of one or more pages. |
| `src/App.jsx` | A supporting project file. |
| `src/components/About.jsx` | A supporting project file. |
| `src/components/Footer.jsx` | A supporting project file. |
| `src/components/Header.jsx` | A supporting project file. |
| `src/components/Hero.jsx` | A supporting project file. |
| `src/components/ImageGallery.jsx` | A supporting project file. |
| `src/index.css` | A stylesheet that controls the visual appearance of one or more pages. |
| `src/index.jsx` | A supporting project file. |
...
> to open Find & Replace across all files. Search for `True React Test` and replace it with your brand name everywhere at once.

### Colours

Open `src/App.css` and look for the `:root` block near the top of the file:
```css
:root {
...
|----------------|-------------|------------------------------|
| Company name (`True React Test`) | All `.html` files | Use Find & Replace to update it everywhere |
...
Open `src/App.css` and find `font-family` on the `body` selector.
...
For background images defined in CSS, open `src/App.css` and search for `background-image`.
